...
function PaymentPageContent() {
  ...
  const handlePaymentSubmit = async (method: "gcash" | "maya" | "bank_transfer", formData: any) => {
    ...
    const messages = isQRTPayment
      ? ["Connecting to payment provider...", "Verifying account...", "Processing payment...", "Generating QR ID..."]
    ...
    try {
      ...
      if (isQRTPayment && qrtRequest) {
        // QR ID GENERATION FLOW
        setProcessingMessage("Generating QR ID...")
        ...
        const newQRTRecord = {
          ...
          fullName: qrtRequest.fullName || "",
          email: qrtRequest.email || user?.email || "",
          phoneNumber: qrtRequest.phoneNumber || "",
          birthDate: qrtRequest.birthDate || "",
        ...
        console.log("[v0] QRT Request processing complete. Proceeding to success page...")
          ...
          <CardContent className="p-6">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">
                    {isQRTPayment ? "QR ID Request" : currentRequest?.certificateType}
                  </h3>
                  <p className="text-sm text-gray-500">
                    {isQRTPayment
                      ? `${qrtRequest?.fullName || "QR ID"} - ${qrtRequest?.requestType === "rush" ? "Rush Processing" : "Regular Processing"}`
            ...
            <div className="space-y-2 border-t border-gray-100 pt-4">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">{isQRTPayment ? "QR ID Fee" : "Certificate Fee"}</span>
